...
public class V16R2 implements Version {
    private final ResourceClient client;
    private final ItemHandler manager;

    public V16R2(@NotNull final ResourceClient client, @NotNull final ItemHandler manager) {
        this.client = client;
    ...
    private String getName(ItemStack bItemStack) {
        ...
        return getLangNameNMS(org.bukkit.craftbukkit.v1_16_R2.inventory.CraftItemStack.asNMSCopy(bItemStack));
    }

    @NotNull
    private String getLangNameNMS(net.minecraft.server.v1_16_R2.ItemStack itemStack) {
