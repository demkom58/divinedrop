...
public class V16R1 implements Version {
    ...
    public V16R1(@NotNull final DivineDrop plugin,
    ...
    private String getName(ItemStack bItemStack) {
        final net.minecraft.server.v1_16_R1.ItemStack itemStack = org.bukkit.craftbukkit.v1_16_R1.inventory.CraftItemStack.asNMSCopy(bItemStack);
        final net.minecraft.server.v1_16_R1.NBTTagCompound nbtTagCompound = itemStack.b("display");

        if (nbtTagCompound != null) {
            if (nbtTagCompound.hasKeyOfType("Name", 8)) {
                final net.minecraft.server.v1_16_R1.IChatBaseComponent name =
                        net.minecraft.server.v1_16_R1.IChatBaseComponent.ChatSerializer.a(nbtTagCompound.getString("Name"));
    ...
    private String getLangNameNMS(net.minecraft.server.v1_16_R1.ItemStack itemStack) {
