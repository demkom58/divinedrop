...
public class V16R3 implements Version {
    private final ResourceClient client;
    private final ItemHandler manager;

    public V16R3(@NotNull final ResourceClient client, @NotNull final ItemHandler manager) {
        this.client = client;
    ...
    private String getName(ItemStack bItemStack) {
        ...
        return getLangNameNMS(org.bukkit.craftbukkit.v1_16_R3.inventory.CraftItemStack.asNMSCopy(bItemStack));
    }

    @NotNull
    private String getLangNameNMS(net.minecraft.server.v1_16_R3.ItemStack itemStack) {
